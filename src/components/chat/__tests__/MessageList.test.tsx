...
function makeMessage(overrides: Partial<UIMessage> & Pick<UIMessage, "role">): UIMessage {
  return {
    id: "1",
    parts: [],
    ...overrides,
...
test("MessageList shows loading state for last assistant message without text", () => {
  const messages: UIMessage[] = [
    makeMessage({
      id: "1",
      role: "assistant",
...
test("MessageList renders multiple messages in correct order", () => {
  const messages: UIMessage[] = [
    makeMessage({ id: "1", role: "user", parts: [{ type: "text", text: "First user message" }] }),
    makeMessage({ id: "2", role: "assistant", parts: [{ type: "text", text: "First assistant response" }] }),
    makeMessage({ id: "3", role: "user", parts: [{ type: "text", text: "Second user message" }] }),
    makeMessage({ id: "4", role: "assistant", parts: [{ type: "text", text: "Second assistant response" }] }),
  ];
...
test("MessageList applies correct styling for user vs assistant messages", () => {
  const messages: UIMessage[] = [
    makeMessage({ id: "1", role: "user", parts: [{ type: "text", text: "User message" }] }),
    makeMessage({ id: "2", role: "assistant", parts: [{ type: "text", text: "Assistant message" }] }),
  ];
...
test("MessageList handles parts rendering", () => {
  const messages: UIMessage[] = [
    makeMessage({
      id: "1",
      role: "assistant",
